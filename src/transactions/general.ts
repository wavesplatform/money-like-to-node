...
export const getDefaultTransform = <TYPE extends number, T extends IDefaultGuiTx<TYPE>>(): { [Key in keyof ITransaction<string, TYPE>]: (data: T) => TWithPartialFee<ITransaction<string, TYPE>>[Key] } => ({
